...
const string inference_1d_2l_chart::INPUTS[INPUTS_COUNT] = {"AO/d", "lambda", "ro_formation"};
const string inference_1d_2l_chart::OUTPUTS[OUTPUTS_COUNT] = {"rok"};

vector<double> inference_1d_2l_chart::calc_predictions(float AO_d, float ro_formation, float lambda) {
    ...
    return std::vector<double>{rok_prediction};
}
