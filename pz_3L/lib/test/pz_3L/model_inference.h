...
namespace inference_pz_3l {
    ...
    // main calc method
    std::vector<double> calc_predictions(double ro_well, double ro_formation, double r_well, double invasion_zone_h, double invasion_zone_ro);
}
