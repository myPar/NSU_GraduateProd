...
namespace inference_1d_3l {
    ...
    // main calc method
    std::vector<double> calc_predictions(double ro_well, double ro_formation, double d_well, double invasion_zone_ro, double invasion_zone_h);
}
